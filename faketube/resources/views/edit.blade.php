        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="name" name="ChannelName" value="{{ $channel->ChannelName }}" class="form-control"
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="sentence" name="SubcribersCount" value="{{ $channel->SubcribersCount }}" class="form-control"
